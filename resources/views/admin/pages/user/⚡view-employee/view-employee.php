...
new #[Layout('layouts.app-admin')] class extends Component
{
    ...
    {
        User::role('employee')->whereIn('id', $this->selectedUsers)->delete();
    ...
    { 
        ...
        { 
            ...
            ->filter(fn($user) => $user->hasRole('employee'))
            ->pluck('id')
            ->map(fn($id) => (int) $id)
            ->toArray(); 
        } else { 
    ...
    {
        $allIds = User::role('employee')->pluck('id')->map(fn($id) => (int) $id)->toArray();
