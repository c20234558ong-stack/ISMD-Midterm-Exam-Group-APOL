        ...
        <div class="lg:pt-13 relative flex flex-col h-full max-h-full">
            ...
            <nav
                ...
                <div class="lg:hidden mb-2 flex items-center justify-between">
                    ...
                    <!-- Sidebar Toggle -->
                    <button type="button" id="no-border"
                ...
                <div 
                    ...
                    <ul class="flex flex-col gap-y-1">
                        <li>
                            <a id="no-border" id="no-border" class="w-full flex items-center gap-x-2 py-2 px-2.5 text-sm text-neutral-200 rounded-lg hover:bg-gray-200 focus:outline-hidden focus:bg-gray-200 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
                ...
                <div
                    ...
                    <ul class="flex flex-col gap-y-1">
                        <li>
                            <a id="no-border" class="w-full flex items-center gap-x-2 py-2 px-2.5 text-sm text-neutral-200 rounded-lg hover:bg-gray-200 focus:outline-hidden focus:bg-gray-200 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
                                wire:current="bg-green-700"
                ...
                <div
                    ...
                    <ul class="flex flex-col gap-y-1">
                        <li>
                            <a id="no-border" class="w-full flex items-center gap-x-2 py-2 px-2.5 text-sm text-neutral-200 rounded-lg dark:hover:bg-neutral-800 dark:focus:bg-neutral-800 hover:bg-gray-200 focus:outline-hidden focus:bg-gray-200"
                                wire:current="bg-green-700"
                                href="/admin/roles">
                                Roles
                            </a>
